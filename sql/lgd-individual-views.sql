...
DROP VIEW IF EXISTS raw_node_tags_boolean CASCADE;
...
DROP VIEW IF EXISTS raw_node_tags_int CASCADE;
...
DROP VIEW IF EXISTS raw_node_tags_float CASCADE;
...
CREATE VIEW lgd_node_tags_float AS
  SELECT a.node_id, b.property, a.v
   FROM raw_node_tags_float a
   JOIN lgd_map_property b ON b.k = a.k;


DROP VIEW IF EXISTS raw_node_tags_uri CASCADE;
CREATE VIEW raw_node_tags_uri AS
...
DROP VIEW IF EXISTS raw_node_tags_text CASCADE;
CREATE VIEW raw_node_tags_text AS
...
CREATE VIEW osm_node_tags_string AS
    SELECT a.node_id, a.k, a.v FROM node_tags a WHERE
        ...
        NOT EXISTS (SELECT c.k FROM lgd_map_language c WHERE c.k = a.k);
...
DROP VIEW IF EXISTS raw_way_tags_boolean CASCADE;
...
DROP VIEW IF EXISTS raw_way_tags_int CASCADE;
...
DROP VIEW IF EXISTS raw_way_tags_float CASCADE;
...
CREATE VIEW lgd_way_tags_float AS
  SELECT a.way_id, b.property, a.v
   FROM raw_way_tags_float a
   JOIN lgd_map_property b ON b.k = a.k;


DROP VIEW IF EXISTS raw_way_tags_uri CASCADE;
...
DROP VIEW IF EXISTS raw_way_tags_text CASCADE;
CREATE VIEW raw_way_tags_text AS
 SELECT a.way_id, a.k, a.v, b.language
   FROM way_tags a
   JOIN lgd_map_language b ON b.k = a.k;

DROP VIEW IF EXISTS osm_way_tags_text CASCADE;
...
CREATE VIEW lgd_way_tags_text AS
 SELECT a.way_id, b.property, a.v, a.language
   FROM raw_way_tags_text a
   JOIN lgd_map_property b ON b.k = a.k;

DROP VIEW IF EXISTS osm_way_tags_string CASCADE;
CREATE VIEW osm_way_tags_string AS
...
DROP VIEW IF EXISTS raw_relation_tags_boolean CASCADE;
...
DROP VIEW IF EXISTS raw_relation_tags_int CASCADE;
...
DROP VIEW IF EXISTS raw_relation_tags_float CASCADE;
...
DROP VIEW IF EXISTS raw_relation_tags_uri CASCADE;
...
DROP VIEW IF EXISTS raw_relation_tags_text CASCADE;
CREATE VIEW raw_relation_tags_text AS
...
DROP VIEW IF EXISTS osm_relation_tags_string CASCADE;
CREATE VIEW osm_relation_tags_string AS
