...
DROP TABLE IF EXISTS lgd_map_language;
CREATE TABLE lgd_map_language (
    k text NOT NULL,
--    property text NOT NULL,
...
CREATE INDEX idx_lgd_map_literal_k ON lgd_map_language(k);
-- CREATE INDEX idx_lgd_map_literal_property ON lgd_map_literal(property);
CREATE INDEX idx_lgd_map_literal_language ON lgd_map_language(language);
