...
CREATE TABLE "lgd_gadm2_lvl_1_data" AS
    SELECT DISTINCT "id_0", "id_1", "name_1", "type_1", "engtype_1", "validfr_1", "validto_1", "remarks_1", "hasc_1", "cca_1", "ccn_1"
    FROM "lgd_gadm2_raw"
...
CREATE INDEX "idx_lgd_gadm2_lvl_1_data_cca_1" ON "lgd_gadm2_lvl_1_data"("cca_1");
CREATE INDEX "idx_lgd_gadm2_lvl_1_data_ccn_1" ON "lgd_gadm2_lvl_1_data"("ccn_1");
...
CREATE TABLE "lgd_gadm2_lvl_2_data" AS
    SELECT DISTINCT "id_0", "id_1", "id_2", "name_2", "type_2", "engtype_2", "validfr_2", "validto_2", "remarks_2", "hasc_2", "cca_2", "ccn_2"
    FROM "lgd_gadm2_raw"
...
CREATE INDEX "idx_lgd_gadm2_lvl_2_data_cca_2" ON "lgd_gadm2_lvl_2_data"("cca_2");
CREATE INDEX "idx_lgd_gadm2_lvl_2_data_ccn_2" ON "lgd_gadm2_lvl_2_data"("ccn_2");
...
CREATE TABLE "lgd_gadm2_lvl_3_data" AS
    SELECT DISTINCT "id_0", "id_1", "id_2", "id_3", "name_3", "type_3", "engtype_3", "validfr_3", "validto_3", "remarks_3", "hasc_3", "cca_3", "ccn_3"
    FROM "lgd_gadm2_raw"
...
CREATE INDEX "idx_lgd_gadm2_lvl_3_data_cca_3" ON "lgd_gadm2_lvl_3_data"("cca_3");
CREATE INDEX "idx_lgd_gadm2_lvl_3_data_ccn_3" ON "lgd_gadm2_lvl_3_data"("ccn_3");
...
CREATE TABLE "lgd_gadm2_lvl_4_data" AS
    SELECT DISTINCT "id_0", "id_1", "id_2", "id_3", "id_4", "name_4", "type_4", "engtype_4", "validfr_4", "validto_4", "remarks_4", "cca_4", "ccn_4"
    FROM "lgd_gadm2_raw"
...
CREATE INDEX "idx_lgd_gadm2_lvl_4_data_cca_4" ON "lgd_gadm2_lvl_4_data"("cca_4");
CREATE INDEX "idx_lgd_gadm2_lvl_4_data_ccn_4" ON "lgd_gadm2_lvl_4_data"("ccn_4");
...
CREATE TABLE "lgd_gadm2_lvl_5_data" AS
    SELECT DISTINCT "id_0", "id_1", "id_2", "id_3", "id_4", "id_5", "name_5", "type_5", "engtype_5", "cca_5", "ccn_5"
    FROM "lgd_gadm2_raw"
    WHERE "id_0" <> 0 AND "id_1" <> 0 AND "id_2" <> 0 AND "id_3" <> 0 AND "id_4" <> 0 AND "id_5" <> 0;
...
CREATE INDEX "idx_lgd_gadm2_lvl_5_data_cca_5" ON "lgd_gadm2_lvl_5_data"("cca_5");
CREATE INDEX "idx_lgd_gadm2_lvl_5_data_ccn_5" ON "lgd_gadm2_lvl_5_data"("ccn_5");
