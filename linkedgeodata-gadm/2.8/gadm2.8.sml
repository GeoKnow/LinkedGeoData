...
Create View gadm_lvl_1_data As
  ...
  With
    ...
    ?cca = plainLiteral(?cca_1)
    ?ccn = plainLiteral(?ccn_1)
  From
...
Create View gadm_lvl_2_data As
  ...
  With
    ...
    ?cca = plainLiteral(?cca_2)
    ?ccn = plainLiteral(?ccn_2)
  From
...
Create View gadm_lvl_3_data As
  ...
  With
    ...
    ?cca = plainLiteral(?cca_3)
    ?ccn = plainLiteral(?ccn_3)
  From
...
Create View gadm_lvl_4_data As
  ...
  With
    ...
    ?cca = plainLiteral(?cca_4)
    ?ccn = plainLiteral(?ccn_4)
  From
...
Create View gadm_lvl_5_data As
  ...
  With
    ...
    ?cca = plainLiteral(?cca_5)
    ?ccn = plainLiteral(?ccn_5)
  From
