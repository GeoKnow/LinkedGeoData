...
public class AppConfig {
    ...
    @Bean
    @Autowired
    public SparqlServiceFactoryImpl sparqlServiceFactory(DataSource dataSource) {
        ...
        SparqlServiceFactoryImpl result = new SparqlServiceFactoryImpl(cacheFrontend);
        return result;
    }
    ...
    @Bean
    @Autowired
    public QueryExecutionFactory queryExecutionFactory(SparqlServiceFactoryImpl sparqlServiceFactory) {
